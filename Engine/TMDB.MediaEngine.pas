...
begin
  ...
  try
    ...
    Result.IdiomaOriginal := LLang.ToUpper;
    LIsAnimacao := False;
    ...
    begin
      ...
      begin
        ...
        else Result.Tags := '#Serie ' + FormatarParaTag('Serie' + LAno);
      end;
    end;
    ...
    begin
      ...
      if Assigned(LArr) and (LArr.Count > 0) then
        Result.LocalProducao := (LArr.Items[0] as TJSONObject).GetValue<string>('name', '')
      else
      begin
